...
<div>
<h2 style="margin-right: 3%; text-align: center;" >فريد <span class="material-icons" style="    font-size: 60px;
    color: #e4cb96;">
    pending_actions
    </span></h2>

    <input id="myInput" type="text" value="${new Date().getDate() + "/" + parseInt(new Date().getMonth() +1) + "/" + new Date().getFullYear()}"><table id="myTable">
    ...
    <tbody>
        <tr v-for="booking in bookings" style="text-align: center;"  v-show="booking.status == 'pending'">
