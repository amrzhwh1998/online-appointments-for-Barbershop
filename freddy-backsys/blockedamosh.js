...
<div id="aemadDiv" >
  ...
  <h1 style="margin-right: 3%; color: #161616;">عباده <span class="material-icons" style="    font-size: 60px;
  color: #e4cb96;">
  pending_actions
  </span></h1>
...
.datepicker-date-display {
    ...
    methods: {
        ...
        onedayaemad() {
            ...
            document.getElementById("myh2id").innerHTML = day + "/" + month + "/" + year;

            this.bookedTimeaemad = []
            this.checkDateaemad()
            this.validationThisDay = true
            ...
            let num = document.getElementById("myh1id").value;
                            ...
                            let time = document.getElementsByClassName('timeaemad')[0].value;
                                        ...
                                        this.$http.post("https://farid-8c572-default-rtdb.firebaseio.com/login.json",
                                        {
                                            ...
                                            this.$http.post("https://farid-8c572-default-rtdb.firebaseio.com/appointmentsamosh/"+num+".json",
                                            {
                                                "customerNumber": num,
        ...
        fetcheraemad() {
            ...
            this.$http.get("https://farid-8c572-default-rtdb.firebaseio.com/appointmentsamosh/" + username + ".json").then(function (data) {
        ...
        removedaemad(event) {
            alert("هل انت متاكد من الغاء حجزك لدى عباده ؟")
                ...
                if (parseInt(document.getElementById("myh2id").innerHTML) == parseInt(sun[i])) {
                    ...
                    if(document.getElementById("myh2id").innerHTML[2] == "/"){
                        if(parseInt(d.getMonth() + 1 ) == parseInt(document.getElementById("myh2id").innerHTML[3] + document.getElementById("myh2id").innerHTML[4])){
                               if (el.innerHTML[0] + el.innerHTML[1] < 12) {
                                     el.disabled = true;
                                     el.style.color = "red";
                                }
                        }
